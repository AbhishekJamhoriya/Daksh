...
class Thread(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            # id = "001"
            data = json.dumps({ "ID":id, "N1":d1,"N2":d2,"N3":d3,"N4":d4,"N5":d5,"N6":d6,"N7":d7,"N8":d8,"N9":d9,"N10":d10,"N11":d11,"N12":d12,"N13":d13,"N14":d14,"N15":d15,"N16":d16,"N17":d17,"N18":d18,"N19":d19,"N20":d20})

            publish.single(topic, data, hostname=MQTT_SERVER,port=1883,client_id="espclient1",qos=1,will=None, tls=None,
            transport="tcp")
            if int(id)%100==0: print("ID = " + id + ", v = " + str(i))
            time.sleep((randint(99,101)/100.0))
